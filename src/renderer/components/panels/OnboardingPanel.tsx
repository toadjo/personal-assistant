...
export function OnboardingPanel({
  ...
  return (
    <section className="panel onboarding">
      ...
      <p className="muted">
        Welcome to PersonalAssistant. This app helps you capture notes, manage tasks, set reminders, and see your day
        at a glance - all from your desktop. Everything stays on your computer. The app lives in your system tray; close
